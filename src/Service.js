        ...
        <div className="row">
          <div className="col-10 mx-auto">
            <div className="row gy-4">
              <Card title="Arm Tattoo" imgsrc={img1} />
              <Card title="Front Tattoo" imgsrc={img2} />
              <Card title="Back Tattoo" imgsrc={img3} />
              <Card title="Neck Tattoo" imgsrc={img4} />
              <Card title="Hide Marks or Scars" imgsrc={img5} />
              <Card title="Remove Tattoo" imgsrc={img6} />
            </div>
          </div>
        </div>
      </div>
